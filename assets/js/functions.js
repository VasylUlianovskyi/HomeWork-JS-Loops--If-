...
function createProductCard(
  ...
  if (productDiscount !== undefined && productDiscount < productPrice) {
    ...
    productCard += `
      ...
      <p class="discount-price">Знижена ціна: ${productDiscount} грн</p>
      <p class="discount">Знижка: ${productPriceDiscount}%</p>
    `;
  } else {
    productCard += `<p>Ціна: ${productPrice} грн</p>`;
  }

  productCard += `
  <button class="btn-cart">Додати в кошик</button>
      </div>
    </article>
  `;
